...
interview <- c("Vidyo Score", "Total Score", "Reviewer Fit", "Interviewer Fit")
school <- c("GPA", "Grad Date", "School Score", "")

# out of 70
total.score <- letter.score + resume.score + reference.score + score$other_score + video$score + candidate$school_score
...
interivew.col <- c(video.hdr, total.hdr, score$application_remark, video$remarks)
school.col <- c(gpa, grad.date, candidate$school_score, "")
...
```{r other, echo=FALSE, results='asis'}

```


Application (`r score$application_reviewer`): `r score$application_comments`

Vidyo (`r video$interviewer`): `r video$comments`
