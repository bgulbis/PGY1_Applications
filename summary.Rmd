...
application <- c("Letter of Intent", "Curriculum Vitae", "Letters of Reference", "Reviewer Fit")
interview <- c("Application Score", "Vidyo Score", "Total Score", "Interviewer Fit")
...
application.col <- c(letter.hdr, resume.hdr, reference.hdr, score$application_remark)
interivew.col <- c(app.score.hdr, video.hdr, total.hdr, video$remarks)
